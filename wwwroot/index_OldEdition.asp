...
border=0>
	...
	Else
			...
			Response.Write(" <!--理论动态栏目内的文章列表-->   <TD><TABLE cellSpacing=0 cellPadding=0 width='100%'>  <TBODY>  <TR><td>")
			'结束画表格，开始列出文章
			'使用原网站的javascript列出文章
			
             ' <!--代码开始-->
			 call ShowArticle_Index(10,rsShowClassArticleListName("ClassID"),-1,10)
            '  <!--代码结束-->
              
			'结束列表，画出下半部分表格
			Response.Write("</td></TR> <TR></TR> </TBODY>  </TABLE></TD> </TR> </TBODY> </TABLE> </DIV></TD></TR>")
