          ...
          <TABLE border="0" cellpadding="0" cellspacing="3">
            <TR>
              <TD >地址：
                ...
                <input type="button" name="Submit" value="从已上传文件中选择" title="文章编辑页面能上传文件" onClick="javascript:window.open('editor_SelectUpFile.asp?DialogType=media', 'selupfile', 'width=800, height=600, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=yes');">
                <%end if%></td>
            </TR>
            <TR>
              <TD >宽度：
                <INPUT name="width" id=width  ONKEYPRESS="event.returnValue=IsDigit();" value=352 size=7 maxlength="4">
                &nbsp;&nbsp;高度：
                <INPUT id=height ONKEYPRESS="event.returnValue=IsDigit();" value=288 size=7 maxlength="4"></TD>
            </TR>
            <TR>
