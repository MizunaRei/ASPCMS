...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td><a href="Admin_Special.asp">课程管理首页</a> | <a href="Admin_Special.asp?Action=Add">添加新课程</a>&nbsp;|&nbsp;<a href="Admin_Special.asp?Action=Order">课程排序</a>&nbsp;|&nbsp;<a href="Admin_Special.asp?Action=Unite">合并课程</a></td>
  </tr>
</table>
<%
if Action="Add" then
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="title"> 
    ...
    <td width="200" align="center"><strong>课程说明</strong></td>
    <td width="100" align="center"><strong>课程浏览权限</strong></td>
...
<form method="post" action="Admin_Special.asp" name="form1">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
   ...
   <!-- 课程简称-->
    <tr class="tdbg"> 
      <td width="350" class="tdbg"><strong> 课程简称：&nbsp;(四个汉字或以内)</strong></td>
