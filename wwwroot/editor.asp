...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="全部选择" LANGUAGE="javascript" onclick="format('selectall')"> 
    <img class="Ico" src="images/editor/selectall.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="删除" LANGUAGE="javascript" onclick="format('delete')"> 
    <img class="Ico" src="images/editor/del.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onclick="format('cut')"> <img class="Ico" src="images/editor/cut.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="复制" LANGUAGE="javascript" onclick="format('copy')"> 
    <img class="Ico" src="images/editor/copy.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="粘贴" LANGUAGE="javascript" onclick="format('paste')"> 
    <img class="Ico" src="images/editor/paste.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="从word中粘贴" LANGUAGE="javascript" onclick="word()"> 
    <img class="Ico" src="images/editor/wordpaste.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="撤消" LANGUAGE="javascript" onclick="format('undo')"> 
    <img class="Ico" src="images/editor/undo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="恢复" LANGUAGE="javascript" onclick="format('redo')"> 
    <img class="Ico" src="images/editor/redo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查找"	LANGUAGE="javascript" onclick="findstr()"> <img class="Ico" src="images/editor/find.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="计算器" LANGUAGE="javascript" onclick="calculator()"> <img class="Ico" src="images/editor/calculator.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="save()"> <img class="Ico" src="images/editor/save.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"><img class="Ico" src="images/editor/help.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"> <img class="Ico" src="images/editor/fgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="文字背景色" LANGUAGE="javascript" onclick="backColor()"> 
    <img class="Ico" src="images/editor/fgbgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="加粗" LANGUAGE="javascript" onclick="format('bold')"> 
    <img class="Ico" src="images/editor/bold.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="斜体" LANGUAGE="javascript" onclick="format('italic')"> 
    <img class="Ico" src="images/editor/italic.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下划线" LANGUAGE="javascript" onclick="format('underline')"> 
    <img class="Ico" src="images/editor/underline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="左对齐" NAME="Justify" LANGUAGE="javascript" onclick="format('justifyleft')"> 
    <img class="Ico" src="images/editor/aleft.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="居中" NAME="Justify" LANGUAGE="javascript" onclick="format('justifycenter')"> 
    <img class="Ico" src="images/editor/acenter.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="右对齐" NAME="Justify" LANGUAGE="javascript" onclick="format('justifyright')"> 
    <img class="Ico" src="images/editor/aright.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="上标" LANGUAGE="javascript" onclick="format('superscript')"> 
    <img class="Ico" src="images/editor/sup.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下标" LANGUAGE="javascript" onclick="format('subscript')"> 
    <img class="Ico" src="images/editor/sub.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="删除文字格式" LANGUAGE="javascript" onclick="format('RemoveFormat')"> 
    <img class="Ico" src="images/editor/clear.gif" WIDTH="18" HEIGHT="18"> </div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  <div class="Btn" TITLE="编号" LANGUAGE="javascript" onclick="format('insertorderedlist')"> 
    <img class="Ico" src="images/editor/num.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="项目符号" LANGUAGE="javascript" onclick="format('insertunorderedlist')"> 
    <img class="Ico" src="images/editor/list.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="减少缩进量" LANGUAGE="javascript" onclick="format('outdent')"> 
    <img class="Ico" src="images/editor/outdent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="增加缩进量" LANGUAGE="javascript" onclick="format('indent')"> 
    <img class="Ico" src="images/editor/indent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="images/editor/url.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
    <img class="Ico" src="images/editor/nourl.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onclick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="images/editor/line.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"><img class="Ico" src="images/editor/sline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入手动分页符" LANGUAGE="javascript" onclick="page()"><img class="Ico" src="images/editor/page.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入当前日期" LANGUAGE="javascript" onclick="nowdate()"> <img class="Ico" src="images/editor/date.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入当前时间" LANGUAGE="javascript" onclick="nowtime()"> <img class="Ico" src="images/editor/time.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()"><img class="Ico" src="images/editor/fieldset.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onclick="iframe()"><img class="Ico" src="images/editor/htm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入Excel表格" LANGUAGE="javascript" onclick="excel()"> 
    <img class="Ico" src="images/editor/excel.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入表格" LANGUAGE="javascript" onclick="InsertTable()"> 
    <img class="Ico" src="images/editor/table.gif" WIDTH="18" HEIGHT="18"> </div>
  ...
  <div class="Btn" TITLE="插入换行符号" LANGUAGE="javascript" onclick="InsertChars(0)"> 
    <img class="Ico" src="images/editor/chars.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="BtnMenu" TITLE="更多特殊符号" LANGUAGE="javascript" onclick="ShowMenu(menu_chars,100)"> 
    <img class="Ico" src="images/editor/arrow.gif" WIDTH="5" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入公式" LANGUAGE="javascript" onclick="InsertEQ()"> <img class="Ico" src="images/editor/eq.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="BtnMenu" TITLE="公式操作" LANGUAGE="javascript" onclick="ShowMenu(menu_eq,100)"> 
    <img class="Ico" src="images/editor/arrow.gif" WIDTH="5" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入图片，支持格式为：jpg、gif、bmp、png等" LANGUAGE="javascript" onclick="pic()"><img class="Ico" src="images/editor/img.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="images/editor/flash.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onclick="wmv()"> 
    <img class="Ico" src="images/editor/wmv.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="images/editor/rm.gif" WIDTH="18" HEIGHT="18"> </div>
</div>
<%
if trim(request("UserType"))="User" then
%>
<iframe class="HtmlEdit" ID="HtmlEdit" src="User_ArticleContent.asp?Action=<%=trim(request("Action"))%>&ArticleID=<%=trim(request("ArticleID"))%>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=296;"> </iframe>
<%else%>
<iframe class="HtmlEdit" ID="HtmlEdit" src="Admin_ArticleContent.asp?Action=<%=trim(request("Action"))%>&ArticleID=<%=trim(request("ArticleID"))%>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=296;"> </iframe>
<%end if%>
