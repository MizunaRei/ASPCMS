...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="Admin_Class_Photo.asp">图片栏目管理首页</a> | <a href="Admin_Class_Photo.asp?Action=Add">添加图片栏目</a>&nbsp;|&nbsp;<a href="Admin_Class_Photo.asp?Action=Order">一级栏目排序</a>&nbsp;|&nbsp;<a href="Admin_Class_Photo.asp?Action=OrderN">N级栏目排序</a>&nbsp;|&nbsp;<a href="Admin_Class_Photo.asp?Action=Reset">复位所有图片栏目</a>&nbsp;|&nbsp;<a href="Admin_Class_Photo.asp?Action=Unite">图片栏目合并</a></td>
  </tr>
</table>
<%
if Action="Add" then
...
%>
  <tr class="tdbg" onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#BFDFFF'"> 
    ...
    <td align="center"><a href="Admin_Class_Photo.asp?Action=Add&ParentID=<%=rsClass("ClassID")%>">添加子栏目</a> 
      | <a href="Admin_Class_Photo.asp?Action=Modify&ClassID=<%=rsClass("ClassID")%>">修改设置</a> 
      | <a href="Admin_Class_Photo.asp?Action=Move&ClassID=<%=rsClass("ClassID")%>">移动栏目</a> 
      | <a href="Admin_Class_Photo.asp?Action=Clear&ClassID=<%=rsClass("ClassID")%>" onClick="return ConfirmDel3();">清空</a> 
      | <a href="Admin_Class_Photo.asp?Action=Del&ClassID=<%=rsClass("ClassID")%>" onClick="<%if rsClass("Child")>0 then%>return ConfirmDel1();<%else%>return ConfirmDel2();<%end if%>">删除</a></td>
  </tr>
  <% 
	rsClass.movenext 
loop 
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg"> 
      <td height="40" colspan="2" align="center"><input name="Action" type="hidden" id="Action" value="SaveAdd"> 
        ...
        &nbsp; <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="window.location.href='Admin_Class_Photo.asp'" style="cursor:hand;"> 
...
<form name="form1" method="post" action="Admin_Class_Photo.asp" onsubmit="return check()">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg"> 
      <td width="350"><strong>所属栏目：</strong><br>
        如果你想改变所属栏目，请<a href='Admin_Class_Photo.asp?Action=Move&ClassID=<%=ClassID%>'>点此移动栏目</a></td>
      <td> <%
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg"> 
      <td height="40" colspan="2" align="center"><input name="Action" type="hidden" id="Action" value="SaveMove"> 
        ...
        &nbsp; 
        <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="window.location.href='Admin_Class_Photo.asp'" style="cursor:hand;"></td></tr>
  </table>
</form>
<%
	end if
  ...
  <tr class="title">  
    ...
    <td align="center">  
      <form name="form1" method="post" action="Admin_Class_Photo.asp?Action=SaveReset"> 
        ...
        <input type="submit" name="Submit" value="复位所有栏目"> &nbsp; <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="window.location.href='Admin_Class_Photo.asp'" style="cursor:hand;">
      </form></td>
    </tr>
</table>
<%
...
sub SaveReset()
	...
	SuccessMsg="复位成功！请返回<a href='Admin_Class_Photo.asp'>栏目管理首页</a>做栏目的归属设置。"
	call WriteSuccessMsg(SuccessMsg)
end sub
