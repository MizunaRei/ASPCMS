  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    ...
    <tr class="tdbg">
      ...
      <td width="65%" class="tdbg"><table width="100%" border="0" cellspacing="1" cellpadding="2">
          <% 'dim Purview %>
          <tr>
            <td width="100"><input name="Purview" type="radio" value="1" checked onClick="PurviewDetail.style.display='none'" <% 'Purview=1 %> >
              超级管理员：</td>
          ...
          <tr>
            <td width="100"><input type="radio" name="Purview" id="Purview3" value="3" onClick="PurviewDetail.style.display=''">
              学生管理员：</td>
            <td>需要详细指定每一项管理权限</td>
          </tr>
        </table></td>
    ...
    <tr class="tdbg">
      <td colspan="2"><table id="PurviewDetail" width="100%" border="0" cellspacing="10" cellpadding="0" style="display:none">
          ...
          <tr valign="top">
                    ...
                    <!-- 两课网站管理信息修改-->
          <tr>
            <td class="tdbg" width="50%"><strong>真实姓名：</strong>&nbsp;&nbsp; </td>
            <td><input name=TrueName type=text   value=""></td>
          </tr>  
		 ...
		 %>
          <!-- 结束两课网站管理员信息修改-->
            ...
            <td width="49%"  colspan="3"><fieldset>
              <legend>留言板</legend>
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    ...
    <tr class="tdbg">
      ...
      <td width="65%" class="tdbg"><table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <!--学生管理员选项-->
          <tr>
            <td width="100"><input type="radio" name="Purview" value="3" onClick="PurviewDetail.style.display=''" <%if rs("Purview")=3 then response.write "checked"%>>
              学生管理员：</td>
            <td>需要详细指定每一项管理权限</td>
          </tr>
          <!--结束学生管理员选项-->
    ...
    <tr class="tdbg">
      <td colspan="2"><table id="PurviewDetail" width="100%" border="0" cellspacing="10" cellpadding="0" <%if rs("Purview")=1 then response.write "style='display:none'"%>>
          ...
          <tr>
            <td class="tdbg" width="50%"><strong>真实姓名：</strong>&nbsp;&nbsp; </td>
            <td><input name=TrueName type=text   value="<%=rs("TrueName")%>"></td>
          </tr>
...
'		  Response.End()
          ...
          <tr valign="top">
            <td width="49%" colspan="2"><fieldset>
              <legend>留言板</legend>
              <table width="100%" border="0" cellspacing="1" cellpadding="2">
                <tr>
...
sub Admin_AddStudentAdminInformation()
        if   1<>3    then
				...
				rsAdmin_Teacher.open sqlAdmin_Teacher,conn,1,1
				  	...
				  	Response.Write("<td><input name=StudentNumber type=text MaxLength=16 value=''></td></tr>")
					Response.Write("<tr> <td width='50%'><strong>任课教师：</strong></td><td> " )		  
