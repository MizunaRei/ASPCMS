<%
const smsImagePath="images/"
const emotsmsImagePath="images/emot/"
...
strContent= re.Replace(strContent,"<br><IMG SRC="""&smsImagePath&"$1.gif"" border=0>此主题相关图片如下：<br><A HREF=""$2$1"" TARGET=_blank><IMG SRC=""$2$1"" border=0 alt=按此在新窗口浏览图片 onload=""javascript:if(this.width>screen.width-333)this.width=screen.width-333""></A>")

re.Pattern="\[UPLOAD=(.[^\[]*)\](.[^\[]*)\[\/UPLOAD\]"
strContent= re.Replace(strContent,"<br><IMG SRC="""&smsImagePath&"$1.gif"" border=0> <a href=""$2"">点击浏览该文件</a>")
...
strContent= re.Replace(strContent,"<img align=absmiddle src=" & smsImagePath & "email1.gif><A HREF=""mailto:$2"">$2</A>")
re.Pattern="(\[EMAIL=(\S+\@.[^\[]*)\])(.[^\[]*)(\[\/EMAIL\])"
strContent= re.Replace(strContent,"<img align=absmiddle src=" & smsImagePath & "email1.gif><A HREF=""mailto:$2"" TARGET=_blank>$3</A>")
...
re.Pattern="\[em(.[^\[]*)\]"
strContent=re.Replace(strContent,"<img src="&emotsmsImagePath&"em$1.gif border=0 align=middle>")
