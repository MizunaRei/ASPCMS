...
'strContent = re.Replace(strContent,"<img align=absmiddle src=" & ImagePath & "url.gif border=0><a target=_blank href=$1>$1</a>")
're.Pattern = "((http|https|ftp|rtsp|mms):(\/\/|\\\\)[A-Za-z0-9\./=\?%\-&_~`@':+!]+)$"
'strContent = re.Replace(strContent,"<img align=absmiddle src=" & ImagePath & "url.gif border=0><a target=_blank href=$1>$1</a>")
're.Pattern = "([^>=""])((http|https|ftp|rtsp|mms):(\/\/|\\\\)[A-Za-z0-9\./=\?%\-&_~`@':+!]+)"
'strContent = re.Replace(strContent,"$1<img align=absmiddle src=" & ImagePath & "url.gif border=0><a target=_blank href=$2>$2</a>")

'自动识别www等开头的网址
're.Pattern = "([^(http://|http:\\)])((www|cn)[.](\w)+[.]{1,}(net|com|cn|org|cc)(((\/[\~]*|\\[\~]*)(\w)+)|[.](\w)+)*(((([?](\w)+){1}[=]*))*((\w)+){1}([\&](\w)+[\=](\w)+)*)*)"
'strContent = re.Replace(strContent,"<img align=absmiddle src=" & ImagePath & "url.gif border=0><a target=_blank href=http://$2>$2</a>")

'自动识别Email地址，如打开本功能在浏览内容很多的帖子会引起服务器停顿
're.Pattern = "([^(=)])((\w)+[@]{1}((\w)+[.]){1,3}(\w)+)"
'strContent = re.Replace(strContent,"<img align=absmiddle src=" & ImagePath & "url.gif border=0><a target=_blank href=""mailto:$2"">$2</a>")
