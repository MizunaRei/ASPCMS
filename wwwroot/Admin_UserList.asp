...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" Class="border">
  <tr class="topbg">
    <td height="22" colspan=3 align=center><strong>学 生 统 计</strong></td>
  </tr>
  <tr class="tdbg">
    <td width="70" height="30"><strong>管理导航：</strong></td>
    <td valign=center><strong><a href="Admin_Course.asp">开课时间班级管理</a>>>学生统计</strong></td><td align=right>鼠标停在文字上将弹出提示</td>
  </tr>
...
elseif Action="SaveAddMoney" then
	call SaveAddMoney()
	'开始思政网的学生统计
	elseif Action="CountByTeacher" then
	call CountByTeacher()
	elseif Action="CountByCollege" then
	call CountByCollege()
	elseif Action="CountByStudentClass" then
	call CountByStudentClass()
else
	call main()
end if
...
<!--<table width="100%"><form>
  <tr class="tdbg">
    <td><strong >统计条件：</strong>
	<%
	'call TeacherTrueNameComboBox()
	%>
    <input type="submit" name="submit" value="进行统计"> </td>
  </tr></form>
</table>-->
<%
...
sub CountByStudentClass()
dim sqlCountByStudentClass , rsCountByStudentClass
%>
...
sqlCountByStudentClass="select * from " & db_User_Table & " where StudentClassName='" & Trim(Request("StudentClassName")) & "' and StudentClassYear='" &  Trim(Request("StudentClassYear")) & "' and StudentClassNumber='" & Trim(Request("StudentClassNumber")) & "'"
rsCountByStudentClass.Open sqlCountByStudentClass,Conn_User,1,3
set rsCountByStudentClass=Server.CreateObject("Adodb.RecordSet")
rsCountByStudentClass.Close
set rsCountByStudentClass=Nothing
end sub
'end sub CountByStudentClass()

sub CountByCollege()
dim rsCountByCollege , sqlCountByCollege
'get接受老师的名字和学院的名字。找到各个学院，分列各学院每名学生
dim CounterStudent
dim rsCountByCollegeStudent , sqlCountByCollegeStudent
%>
<table  width="100%"  border="0">
  <tr class="title">
    <td>网名</td>
...
<%
sqlCountByCollege="select * from CourseList where TeacherName='" & Trim(Request("TeacherName")) &"'"
set rsCountByCollege=Server.CreateObject("Adodb.RecordSet")
rsCountByCollege.Open sqlCountByCollege,conn,1,3
	do while not rsCountByCollege.eof
		sqlCountByCollegeStudent="select * from " & db_User_Table & " where College='" & rsCountByCollege("College") & "' order by StudentNumber asc"
		set rsCountByCollegeStudent=Server.CreateObject("Adodb.RecordSet")
		rsCountByCollegeStudent.Open sqlCountByCollegeStudent,Conn_User,1,3
			Do While Not rsCountByCollegeStudent.EOF
				%>
			<tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'">
			<%

			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByCollegeStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByCollegeStudent(db_User_Name) & "</a></td>"
			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByCollegeStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByCollegeStudent(db_User_TrueName) & "</a></td>"
			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByCollegeStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByCollegeStudent(db_User_StudentNumber) & "</a></td>"
			response.write "<td><a href='Admin_UserList.asp?Action=CountByStudentClass&StudentClass=" &   rsCountByCollegeStudent("StudentClassName") & rsCountByCollegeStudent("StudentClassYear") & rsCountByCollegeStudent("StudentClassNumber")  & "' title='点击查看此班级所有学生' >" & rsCountByCollegeStudent("StudentClassName") & rsCountByCollegeStudent("StudentClassYear") & rsCountByCollegeStudent("StudentClassNumber") & "</a></td>"
			'Response.Write("<td><a href='Admin_UserList.asp?Action=CountByCollege")'此行无用
			response.write "<td><a href='Admin_UserList.asp?Action=CountByCollege&College='" & rsCountByCollegeStudent(db_User_College) & "' title='点击查看此学院所有学生' >" & rsCountByCollegeStudent(db_User_College) & "</a></td>"
			Response.Write("<td align='right'>" & rsCountByCollegeStudent(db_User_ArticleChecked) & "</td>")
				set rsArticleCommentScore=server.createobject("adodb.recordset")
				sqlArticleCommentScore="select sum(ArticleComment.Score) from Article,ArticleComment where Article.ArticleID=ArticleComment.ArticleID and Article.Author='" & rsCountByCollegeStudent(db_User_Name)  & "'"
				rsArticleCommentScore.open sqlArticleCommentScore,Conn,3,1
				Response.Write("<td  align='right'> " & rsArticleCommentScore(0) & "</td></tr>" )
				rsArticleCommentScore.Close
				set rsArticleCommentScore=nothing
				CounterStudent=CounterStudent+1
			rsCountByCollegeStudent.MoveNext
			Loop

		rsCountByCollegeStudent.Close
		Set rsCountByCollegeStudent=Nothing


	rsCountByCollege.movenext
	loop
rsCountByCollege.Close
set rsCountByCollege=nothing
%>
<tr class="topbg">
    <td height="22" colspan=30 align=center>
	<%
	Response.Write("<strong>" & Trim(Request("TeacherName")) & " </strong>" & "老师为<strong>" & CounterStudent & " </strong>名学生授课" )
	%>
	</td>
</tr></table>
<%
end sub
'end sub CountByCollege


sub CountByTeacher()
'先查出教师带哪些班，再查班里有哪些学生
dim CounterStudent , CounterStudentClass
dim rsCountByTeacher ,  sqlCountByTeacher
dim rsCountByTeacherStudent  , sqlCountByTeacherStudent
dim rsArticleCommentScore , sqlArticleCommentScore
CounterStudent=0
CounterStudentClass=0
sqlCountByTeacher="select * from CourseList where TeacherName='" & Trim(Request("TeacherName")) & "'"
set rsCountByTeacher=Server.CreateObject("Adodb.RecordSet")
rsCountByTeacher.Open sqlCountByTeacher , conn,1,3
	%>
<table  width="100%"  border="0">
  <tr class="title">
    <td>网名</td>
...
<%
	do while not rsCountByTeacher.eof
		sqlCountByTeacherStudent="select * from " & db_User_Table & " where StudentClassName='" & rsCountByTeacher("StudentClassName") & "' and StudentClassYear='" & rsCountByTeacher("StudentClassYear") & "' and StudentClassNumber='" &  rsCountByTeacher("StudentClassNumber")  & "'  order by StudentNumber asc"

		set		rsCountByTeacherStudent=Server.CreateObject("Adodb.RecordSet")
		rsCountByTeacherStudent.Open sqlCountByTeacherStudent,Conn_User,1,3
			do while not rsCountByTeacherStudent.eof
			%>
			<tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'">
			<%
			'Response.Write("<td>")
			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByTeacherStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByTeacherStudent(db_User_Name) & "</a></td>"
			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByTeacherStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByTeacherStudent(db_User_TrueName) & "</a></td>"
			response.write "<td><a href='UserInfo.asp?UserID=" & rsCountByTeacherStudent(db_User_ID) & "' title='点击查看该生详细信息' >" & rsCountByTeacherStudent(db_User_StudentNumber) & "</a></td>"
			response.write "<td><a href='Admin_UserList.asp?Action=CountByStudentClass&StudentClass=" &   rsCountByTeacherStudent("StudentClassName") & rsCountByTeacherStudent("StudentClassYear") & rsCountByTeacherStudent("StudentClassNumber")  & "' title='点击查看此班级所有学生' >" & rsCountByTeacherStudent("StudentClassName") & rsCountByTeacherStudent("StudentClassYear") & rsCountByTeacherStudent("StudentClassNumber") & "</a></td>"
			response.write "<td><a href='Admin_UserList.asp?Action=CountByCollege" & rsCountByTeacherStudent(db_User_College) & "' title='点击查看此学院所有学生' >" & rsCountByTeacherStudent(db_User_College) & "</a></td>"
			Response.Write("<td align='right'>" & rsCountByTeacherStudent(db_User_ArticleChecked) & "</td>")
			set rsArticleCommentScore=server.createobject("adodb.recordset")
			sqlArticleCommentScore="select sum(ArticleComment.Score) from Article,ArticleComment where Article.ArticleID=ArticleComment.ArticleID and Article.Author='" & rsCountByTeacherStudent(db_User_Name)  & "'"
			rsArticleCommentScore.open sqlArticleCommentScore,Conn,3,1
			...
			'Response.Write("</tr>")
			CounterStudent=CounterStudent+1
			rsCountByTeacherStudent.MoveNext
			loop
		rsCountByTeacherStudent.Close
		set rsCountByTeacherStudent=nothing

		CounterStudentClass=CounterStudentClass+1
	rsCountByTeacher.MoveNext
	loop




rsCountByTeacher.Close
set rsCountByTeacher=nothing
...
<tr class="topbg">
    <td height="22" colspan=30 align=center>
	<%
	Response.Write("<strong>" & Trim(Request("TeacherName")) & " </strong>" & "老师为<strong> " & CounterStudentClass & " </strong>个班级共<strong> " & CounterStudent & " </strong>名学生授课" )
...
<table width='100%' border="0" cellpadding="0" cellspacing="0">
  <tr>
    <form name="myform" method="Post" action="Admin_User.asp" onSubmit="return confirm('确定要执行选定的操作吗？');">
      <td height="90"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
          <tr class="title">
          ...
          <%do while not rs.EOF %>
          <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'">
            <td width="30" height="22" align="center"><input name='UserID' type='checkbox' onClick="unselectall()" id="UserID" value='<%=cstr(rs(db_User_ID))%>'></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><strong>操作：</strong>
              ...
              解锁 &nbsp;&nbsp;&nbsp;
              <input name="Action" type="radio" value="Move" onClick="document.myform.UserLevel.disabled=false">
              移动到
...
<form name="form2" method="post" action="Admin_User.asp">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" class="border">
    <tr class="tdbg">
      ...
      <td width="300"><select name="Field" id="Field">
          <option value="UserID" selected>用户ID</option>
          <option value="UserName">用户名</option>
        </select>
        <input name="Keyword" type="text" id="Keyword" size="20" maxlength="30">
        <input type="submit" name="Submit2" value=" 查 询 ">
        <input name="UserSearch" type="hidden" id="UserSearch" value="10"></td>
      <td>若为空，则查询所有用户</td>
    </tr>
  </table>
</form>
...
<FORM name="Form1" action="Admin_User.asp" method="post">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" class="border">
    ...
    <TR class="tdbg" >
      <TD width="40%"><strong>密码问题：</strong><br>
        忘记密码的提示问题</TD>
      <TD width="60%"><INPUT name="Question"   type=text value="<%=rsUser(db_User_Question)%>" size=30></TD>
    </TR>
    <TR class="tdbg" >
      <TD width="40%"><strong>问题答案：</strong><BR>
        忘记密码的提示问题答案，用于取回密码</TD>
      <TD width="60%"><INPUT   type=text size=30 name="Answer">
        <font color="#FF0000">如果不想修改，请留空</font></TD>
    </TR>
    <TR class="tdbg" >
      <TD width="40%"><strong>性别：</strong></TD>
    ...
    <TR class="tdbg" >
      <TD height="40" colspan="2" align="center"><input name="Action" type="hidden" id="Action" value="SaveModify">
        ...
        <input name="UserID" type="hidden" id="UserID" value="<%=rsUser(db_User_ID)%>"></TD>
    </TR>
  </TABLE>
</form>
<%
...
<FORM name="Form1" action="Admin_User.asp" method="post">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" class="border">
    ...
    <TR class="tdbg" >
	  ...
	  %>
        <input name="ChargeType" type="hidden" id="ChargeType" value="<%=rsUser(db_User_ChargeType)%>"></TD>
    </TR>
    <%if rsUser(db_User_ChargeType)=1 then%>
    <TR class="tdbg" >
    ...
    <tr class="tdbg" >
      ...
      <td><input name="Valid_Num" type="text" id="Valid_Num" value="1" size="10" maxlength="10">
